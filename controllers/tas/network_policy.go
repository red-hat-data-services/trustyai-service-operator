...
func (r *TrustyAIServiceReconciler) ensureNetworkPolicy(ctx context.Context, instance *trustyaiopendatahubiov1alpha1.TrustyAIService) error {
...
func (r *TrustyAIServiceReconciler) desiredNetworkPolicySpec(instance *trustyaiopendatahubiov1alpha1.TrustyAIService) networkingv1.NetworkPolicySpec {
